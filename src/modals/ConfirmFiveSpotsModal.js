...
const ConfirmFiveSpotsModal = ({ showModal_ConfirmFiveSpots, setShowModal_ConfirmFiveSpots }) => {

    const handleSubmit = () => {
      setShowModal_ConfirmFiveSpots(false)
    }
    ...
    return (
        <>
        <Modal visible={showModal_ConfirmFiveSpots} contentContainerStyle={styles.containerStyle}>
            ...
            <View style={{height: 80, width: '100%', justifyContent: 'flex-end'}}>
              <Text style={styles.header}>Confirm these 5 spots?</Text>
            </View>


            <View style={{width: '84%'}}>
              <Text style={styles.subtitle}> You will not be able to change them until next Sunday.</Text>
...
export default ConfirmFiveSpotsModal;
