...
const NoLikeModal = ({ showModal_NoLike, setShowModal_NoLike }) => {

    const handleSubmit = () => {
        setShowModal_NoLike(false)
    }
    ...
    return (
        <>
        <Modal visible={showModal_NoLike} contentContainerStyle={styles.containerStyle}>
            ...
            <View style={{height: 80, width: '100%', justifyContent: 'flex-end'}}>
              <Text style={styles.header}>No Likes Left Today</Text>
            </View>
            <View style={[globalStyle.center, {marginTop: 0, marginBottom: 0}]}>
              <Image source={require('../assets/unlock_heart.png')}  style={{height:74, resizeMode: 'contain' }} />
            </View>

            <Text style={styles.subtitle}>Get unlimited likes with VIP Access</Text>
            ...
            <TouchableOpacity onPress={handleSubmit} style={styles.btn}>            
               <Text style={styles.btntext}>Get More Likes</Text>
            </TouchableOpacity>
        </Modal>
        </>
    )
