...
const InterestedModal = ({ showModal_Intersted, setShowModal_Intersted }) => {

    const handleSubmit = () => {
        setShowModal_Intersted(false)
    }
    ...
    return (
        <>
        <Modal visible={showModal_Intersted} contentContainerStyle={styles.containerStyle}>
            ...
            <View style={{height: 80, width: '100%', justifyContent: 'flex-end'}}>
              <Text style={styles.header}>Interested?</Text>
            </View>


            <View style={{width: '84%'}}>
              <Text style={styles.subtitle}>Clicking the “Heart” button means you’re interested in that person</Text>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between',  marginVertical : 30 }}>
                ...
                <TouchableOpacity style={styles.btnRight} onPress={closeModal}>
                  <Text style={[styles.btntext, { color: '#FFFFFF' }]}>I’m Interested</Text>
                </TouchableOpacity>
              </View>    
            </View>
        </Modal>
